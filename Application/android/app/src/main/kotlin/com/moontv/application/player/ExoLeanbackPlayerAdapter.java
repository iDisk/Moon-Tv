 ...
 */
public final class ExoLeanbackPlayerAdapter extends PlayerAdapter implements Runnable {
     ...
     */
    public ExoLeanbackPlayerAdapter(Context context, Player player, final int updatePeriodMs, final SubtitleView subtitleView) {
    ...
    private final class PlayerListener implements Player.Listener, SurfaceHolder.Callback {
        ...
        public void onPlayerError(PlaybackException error) {
            ...
            if (errorMessageProvider != null) {
                ...
                callback.onError(ExoLeanbackPlayerAdapter.this, errorMessage.first, errorMessage.second);
            } else {
                callback.onError(
                        ExoLeanbackPlayerAdapter.this,
                        error.errorCode,
        ...
        public void onTimelineChanged(Timeline timeline, @Player.TimelineChangeReason int reason) {
            Callback callback = getCallback();
            callback.onDurationChanged(ExoLeanbackPlayerAdapter.this);
            callback.onCurrentPositionChanged(ExoLeanbackPlayerAdapter.this);
            callback.onBufferedPositionChanged(ExoLeanbackPlayerAdapter.this);
        }
        ...
        public void onVideoSizeChanged(VideoSize videoSize) {
            ...
            getCallback().onVideoSizeChanged(ExoLeanbackPlayerAdapter.this, scaledWidth, videoSize.height);
        }
