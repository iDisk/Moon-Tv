...
class CategoriesDialog extends StatelessWidget {
  ...
  Function close;
  Function select;
  CategoriesDialog({this.categoriesList, this.visibile, this.focused_category, this.selected_category, this.categoriesScrollController, this. close,this.select});
