...
class SourcesDialog extends StatefulWidget {
  ...
  SourcesDialog({this.sourcesList,this.sourcesScrollController,this.focused_source,this.selected_source,this.visibileSourcesDialog,this.close,this.select});
