...
import 'package:flutter_app_tv/ui/player/video_player_test.dart';
...
class _MovieState extends State<Movie> {
        ...
        Navigator.push(
          ...
          PageRouteBuilder(
            pageBuilder: (context, animation1, animation2) => ReviewAdd(
                image: widget.movie.image, id: widget.movie.id, type: "movie"),
            transitionDuration: Duration(seconds: 0),
          ),
        );
      } else {
  ...
  void _playSource() async {
    if (widget.movie.sources[_selected_source].type == "youtube" ||
      ...
      //   context,
      //   PageRouteBuilder(
      //     pageBuilder: (context, animation1, animation2) => VideoPlayer1(sourcesList: _sources,selected_source:_new_selected_source,focused_source: _new_selected_source,poster: widget.movie),
      //     transitionDuration: Duration(seconds: 0),
      //   ),
      // );
    }
