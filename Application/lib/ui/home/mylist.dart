...
class _MyListState extends ResumableState<MyList> {
    ...
    if(response == null){
      ...
      if (response.statusCode == 200) {
        ...
        if(jsonData["posters"] != null){
            ...
            for(Map poster_map  in jsonData["posters"]){
  ...
  Widget getBackgroundImage() {
      ...
      return ImageFade(image:NetworkImage((selected_channel!= null)? selected_channel.image:selected_poster.cover),fit: BoxFit.cover);
