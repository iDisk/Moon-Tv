                ...
                child: new RawKeyboardListener(
                  ...
                  child: new ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor:
                          focusNodes[0].hasFocus ? Colors.red : Colors.grey,
                    ),
                    onPressed: () {
                      Navigator.of(context).pushNamed('/a');
                    },
              ...
              new Container(
                ...
                child: new RawKeyboardListener(
                  ...
                  child: new ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                        backgroundColor:
                            focusNodes[1].hasFocus ? Colors.red : Colors.grey),
                    onPressed: () {
                      Navigator.of(context).pushNamed('/b');
                    },
                  ),
              ...
              new Container(
                ...
                child: new RawKeyboardListener(
                  ...
                  child: new ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                        backgroundColor:
                            focusNodes[2].hasFocus ? Colors.red : Colors.grey),
                    onPressed: () {
                      Navigator.of(context).pushNamed('/c');
                    },
                  ),
              ...
              new Container(
                ...
                child: new RawKeyboardListener(
                  ...
                  child: new ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                        backgroundColor:
                            focusNodes[3].hasFocus ? Colors.red : Colors.grey),
                    onPressed: () {
                      Navigator.of(context).pushNamed('/a');
                    },
                  ),
              ...
              new Container(
                ...
                child: new RawKeyboardListener(
                  ...
                  child: new ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                        backgroundColor:
                            focusNodes[4].hasFocus ? Colors.red : Colors.grey),
                    onPressed: () {
                      Navigator.of(context).pushNamed('/b');
                    },
                  ),
              ...
              new Container(
                ...
                child: new RawKeyboardListener(
                  ...
                  child: new ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                        backgroundColor:
                            focusNodes[5].hasFocus ? Colors.red : Colors.grey),
                    onPressed: () {
                      Navigator.of(context).pushNamed('/c');
                    },
                  ),
              ...
              new Container(
                ...
                child: new RawKeyboardListener(
                  ...
                  child: new ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                        backgroundColor:
                            focusNodes[6].hasFocus ? Colors.red : Colors.grey),
                    onPressed: () {
                      Navigator.of(context).pushNamed('/a');
                    },
                  ),
              ...
              new Container(
                ...
                child: new RawKeyboardListener(
                  ...
                  child: new ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                        backgroundColor:
                            focusNodes[7].hasFocus ? Colors.red : Colors.grey),
                    onPressed: () {
                      Navigator.of(context).pushNamed('/b');
                    },
                  ),
              ...
              new Container(
                  ...
                  child: RawKeyboardListener(
                    ...
                    child: new ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                          backgroundColor: focusNodes[8].hasFocus
                              ? Colors.red
                              : Colors.grey),
                      onPressed: () {
                        Navigator.of(context).pushNamed('/b');
